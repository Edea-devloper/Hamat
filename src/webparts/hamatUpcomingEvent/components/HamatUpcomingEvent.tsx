...
import type { IHamatUpcomingEventProps } from './IHamatUpcomingEventProps';
...
const HamatEventsCalendar: React.FC<IHamatUpcomingEventProps> = ({ eventList, employeePermissionList, previousDays, upcomingDays, showAllCompany, displayMode, context, eventDisplayTitle, defaultColor }) => {
  ...
  return (
    <section>
      ...
      <Events eventListData={eventListData} addedCalendarEvent={addedCalendarEvent}
        previousDays={previousDays} upcomingDays={upcomingDays} setShowLoader={setShowLoader}
        eventDisplayTitle={eventDisplayTitle} defaultColor={defaultColor} />
    </section>
  );
};
